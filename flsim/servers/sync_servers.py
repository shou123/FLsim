...
class SyncServer(ISyncServer):
    ...
    def step(self):
        ...
        # print(aggregated_model.fl_get_module())
        # aggregated_model_object = self.get_state_dict(aggregated_model.fl_get_module(), False)
        # before_module_file = "/home/shiyue/FLSim/results/" + str(aggregated_model)
        # with open(before_module_file, 'a') as file:
        #     for key, value in aggregated_model_object.items():
        #         file.write(f"{key}: {value}\n")
        self._optimizer.step()
        
    def get_state_dict(self, model: nn.Module, only_federated_params: bool):
